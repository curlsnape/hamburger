...
>
  {ismenuopen ? (
    <IoCloseOutline className="font-semibold hover:bg-purple-600 hover:text-white h-8 transition-all duration-300 hover:scale-125 w-8 p-2 rounded-full" />
      ...
      {ismenuopen && (
  <div
    className="absolute top-16 left-0 w-full bg-white shadow-lg rounded-lg px-8 py-6 transition-transform duration-300 ease-in-out transform scale-y-100 origin-top"
  >
